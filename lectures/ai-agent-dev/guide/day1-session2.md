...
> 실습 상세는 `labs/day1/s2-context-strategy/README.md` 참고

### 시연 (20분)

강사가 PydanticAI Agent로 컨텍스트 전략별 응답 차이를 시연한다.

- `src/01_demo_context_strategies.ipynb` — System Prompt 유무, 컨텍스트 양, Structured Output 비교

### 실습 (25분)

LangSmith 트레이싱 셋업 + PydanticAI Structured Output 패턴 실습.

- `src/02_setup_langsmith.ipynb` — LangSmith 연동 + Structured Output

### 과제 (35분)

자기 도메인 태스크에 3가지 컨텍스트 전략을 적용하고 정확도·비용 비교.

- `src/03_context_lab.ipynb` — TODO 채워서 전략 비교
- 정답: `solution/01_context_strategies.ipynb`
